from text import chinese_mfa, japanese, cleaned_text_to_sequence, symbols, english
from text.chinese_mfa import TextTokenizer
from text.symbol_table import SymbolTable
import os
current_file_path = os.path.dirname(__file__)

language_module_map = {"zh": chinese_mfa, "ja": japanese, "en": english}
special = [
    # ("%", "zh", "SP"),
    ("￥", "zh", "SP2"),
    ("^", "zh", "SP3"),
