...
checkpoint = torch.load(f'./output/large-03.4000.pt', map_location="cpu")
...
# }
# x=1
# torch_y = torchaudio.transforms.GriffinLim(**stft_params, power=x)(spec)
# torchaudio.save('reconstructed_origin_spec_torch.wav', torch_y, config.audio.sample_rate)

# torch_y = torchaudio.transforms.GriffinLim(**stft_params, power=x)(spec_processed)
